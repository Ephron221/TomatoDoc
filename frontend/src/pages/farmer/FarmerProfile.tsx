  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-gray-900 tracking-tight">Farmer Profile</h1>
          <p className="text-gray-500 mt-1">Manage your account details and security settings.</p>
        </div>
        <div className="px-4 py-2 bg-green-50 border border-green-100 rounded-2xl flex items-center space-x-3 text-green-700">
          ...
          <form onSubmit={handleProfileUpdate} className="bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-xl shadow-gray-200/50">
            <div className="flex items-center space-x-6 mb-10">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-2 font-black uppercase tracking-widest">Agricultural Producer</p>
                <div className="flex items-center mt-3 text-[10px] text-green-600 bg-green-50 px-3 py-1 rounded-full font-black uppercase tracking-wider w-fit">
                  <Shield className="w-3 h-3 mr-1.5" /> Verified Profile
                </div>
              </div>
            </div>
